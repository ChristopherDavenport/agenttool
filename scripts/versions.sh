...
#
#   scripts/versions.sh set   v0.1.0 mcpclient mcpserver
#   scripts/versions.sh check v0.1.0 mcpclient mcpserver
#
...
MODULE_ROOT="github.com/ChristopherDavenport/agenttool"
